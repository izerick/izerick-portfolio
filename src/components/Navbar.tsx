    ...
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled || mobileMenuOpen
          ? 'bg-[#070406]/98 backdrop-blur-xl border-b border-rose-950/70 py-3 shadow-[0_10px_30px_rgba(0,0,0,0.8)]'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2.5 sm:gap-3 group">
          ...
          <div>
            ...
            <span className="text-[10px] text-slate-400 font-sans block truncate max-w-[170px] sm:max-w-none">
            ...
            return (
              <Link
                ...
                className={`transition-all py-1 px-2 rounded-lg ${
                  isActive
                    ? 'text-white font-bold bg-rose-950/50 border border-rose-500/40 text-rose-300'
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          {/* Highlighted Cotizar Ahora Button */}
          <Link
            to="/cotizar"
        ...
        <button
          ...
          className="md:hidden p-2 rounded-xl bg-[#140b0f] border border-rose-900/50 text-slate-200 hover:text-white focus:outline-none transition-colors"
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="px-5 pt-3 pb-6 space-y-2">
              ...
              {/* Highlighted Cotizar CTA in Mobile */}
              <div className="pt-2">
                <Link
                  to="/cotizar"
                  onClick={() => setMobileMenuOpen(false)}
