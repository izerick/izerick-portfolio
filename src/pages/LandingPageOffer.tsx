...
export const LandingPageOffer: React.FC = () => {
  ...
  const whatsappUrl = `https://wa.me/593999792353?text=${encodeURIComponent(
    '¡Hola Erick! Vengo desde la página de oferta de izerick.dev y deseo solicitar el Plan Web Todo Incluido por $35 USD/mes (contrato 12 meses).'
  )}`;
        ...
        <div className="text-center max-w-4xl mx-auto mb-20">
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/cotizar"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-gradient-to-r from-rose-600 via-red-600 to-rose-700 hover:from-rose-500 hover:to-red-500 text-white font-extrabold text-sm flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(244,63,94,0.4)] transition-all"
              >
                <span>Solicitar Plan en el Cotizador</span>
                <ArrowRight className="w-4 h-4" />
              </Link>
              
              <Link
                to="/contacto"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 font-bold text-sm flex items-center justify-center gap-2 border border-white/10 transition-colors"
              >
                <span>Preguntas &amp; Contacto</span>
              </Link>
            </div>
          </motion.div>
        </div>
          ...
          <div className="lg:col-span-7 tech-card rounded-3xl p-8 sm:p-10 bg-gradient-to-b from-[#180a13] to-[#0f060b] border-2 border-rose-500/50 shadow-[0_0_60px_rgba(244,63,94,0.25)] relative overflow-hidden">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                { icon: MessageCircle, title: 'Botón Directo a WhatsApp & Formularios', desc: 'Captura de clientes en automático que te contactan con un solo clic.' },
            ...
            <a
              ...
              className="w-full py-4 px-6 rounded-xl bg-gradient-to-r from-rose-600 via-red-600 to-rose-700 hover:from-rose-500 hover:to-red-500 text-white font-bold text-sm font-sans flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(244,63,94,0.4)] transition-all group"
            >
              <span>Comenzar con el Primer Mes ($35 USD)</span>
